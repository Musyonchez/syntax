"""
Utility functions for SyntaxMem Cloud Functions
"""
import re
import hashlib
...
def create_response(data: Any = None, message: str = "Success", status: str = "success") -> Dict[str, Any]:
...
def create_error_response(message: str, error_code: str = "UNKNOWN_ERROR", details: Any = None) -> Dict[str, Any]:
