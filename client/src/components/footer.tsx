        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Master coding through simplicity. Interactive practice sessions, 
              curated snippets, and community-driven learning.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Link href="/practice" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">
                Practice Sessions
              </Link>
              <Link href="/snippets" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">
                Code Snippets
              </Link>
              <Link href="/leaderboard" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">
                Leaderboard
              </Link>
              <Link href="/forum" className="block text-sm text-muted-foreground hover:text-foreground transition-colors">
                Community Forum
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <a 
                href="https://github.com/syntaxmem" 
                target="_blank" 
              ...
              <a 
                href="https://discord.gg/syntaxmem" 
                target="_blank" 
                rel="noopener noreferrer"
                className="block text-sm text-muted-foreground hover:text-foreground transition-colors"
              >
              ...
              <a 
                href="https://twitter.com/syntaxmem" 
                target="_blank" 
                rel="noopener noreferrer"
                className="block text-sm text-muted-foreground hover:text-foreground transition-colors"
              >
        ...
        <div className="py-6 border-t border-border">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="text-xs text-muted-foreground/80">
              © 2025 SyntaxMem. All rights reserved.
            </div>
